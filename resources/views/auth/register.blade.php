        ...
        <div class="md:mx-96 mt-12">
            ...
            <form action="{{ route('auth.signUp') }}" method="POST">
                ...
                <div class="col-span-6 sm:col-span-3 mb-4">
                    ...
                    <input type="email" placeholder="example@gmail.com" name="email" id="email" oninput="checkEmail()"
                        class="mt-1 focus:ring-brown-500 focus:border-brown-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    <p id="alert-email" class="hidden mt-1 text-xs text-red-500">
                        Alamat e-mail yang anda masukkan sudah terdaftar, Silahkan masukkan alamat e-mail yang lain
                    </p>
                </div>
                <div class="col-span-6 sm:col-span-3 mb-4">
                    <label for="nama_lengkap" class="block text-sm font-medium text-gray-700">Nama Lengkap</label>
                    <input type="text" placeholder="John Doe" name="nama_lengkap" id="nama_lengkap"
                        class="mt-1 focus:ring-brown-500 focus:border-brown-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                <div class="col-span-6 sm:col-span-3 mb-4">
                    <label for="no_telp" class="block text-sm font-medium text-gray-700">No. Telepon</label>
                    <input type="text" placeholder="0812345678912" name="no_telp" id="no_telp"
                        class="mt-1 focus:ring-brown-500 focus:border-brown-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                <div class="col-span-6 sm:col-span-3 mb-4">
                    <label for="provinsi" class="block text-sm font-medium text-gray-700">Provinsi</label>
                    <select id="provinsi" name="provinsi" onchange="getRegencies()"
                ...
                <div class="col-span-6 sm:col-span-3 mb-4">
                    ...
                    <select id="kota_kab" name="kota_kab" disabled onchange="getDistricts()"
                        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-brown-500 focus:border-brown-500 sm:text-sm">
                    </select>
                </div>
                <div class="col-span-6 sm:col-span-3 mb-4">
                    <label for="kecamatan" class="block text-sm font-medium text-gray-700">Kecamatan</label>
                    <select id="kecamatan" name="kecamatan" disabled onchange="getVillages()"
                        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-brown-500 focus:border-brown-500 sm:text-sm">
                ...
                <div class="col-span-6 sm:col-span-3 mb-4">
                    ...
                    <select id="desa_kel" name="desa_kel" disabled
                        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-brown-500 focus:border-brown-500 sm:text-sm">
                ...
                <div class="col-span-6 sm:col-span-3 mb-4">
                    ...
                    <input type="text" name="username" id="username" oninput="checkUsername()"
                        class="mt-1 focus:ring-brown-500 focus:border-brown-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    <p id="alert-username" class="hidden mt-1 text-xs text-red-500">
                ...
                <p class="">Sudah punya akun ? <a class="hover:underline font-semibold"
                        href="{{ route('auth.loginView') }}">Login disini</a></p>
            </form>
        </div>
    </div>
</main>
